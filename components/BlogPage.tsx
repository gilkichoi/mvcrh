    ...
    <div className="py-24 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <h2 className="text-teal-600 font-bold uppercase tracking-widest text-sm mb-2">Health Education</h2>
          <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">Medical Blog & Health Tips</h3>
          <p className="text-slate-600 max-w-2xl mx-auto text-lg">
            Stay informed with the latest health advice, preventive care tips, and medical news from our experts.
          </p>
        </div>
          ...
          {mockBlogPosts.map(post => (
            <div key={post.id} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100 flex flex-col group">
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <h4 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-teal-600 transition-colors">{post.title}</h4>
