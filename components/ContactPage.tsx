      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto text-lg">
            We are here to help. Reach out to us for any inquiries, appointments, or emergency assistance.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-center">
            ...
            <h4 className="font-bold text-slate-900 mb-2">Emergency Line</h4>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-center">
            ...
            <p className="text-slate-500 text-sm mb-4">For general inquiries</p>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-center">
            ...
            <p className="text-slate-500 text-sm mb-4">Visit our facility</p>
            <p className="text-md font-bold text-slate-700">Voi Town, Off Nairobi-Mombasa Highway, Kenya</p>
          </div>
        </div>
            ...
            <div className="p-12">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea rows={5} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-teal-500 outline-none" placeholder="How can we help you?"></textarea>
                </div>
